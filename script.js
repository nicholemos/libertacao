...
,
	...
	serviços:" Clareiras para treinos e meditação, território de caça ou coleta de materiais e ingredientes encontrados nos ermos.",
	...
	serviços:" Seus PV máximos aumentam em +5 por patamar. Uma noite aqui também remove qualquer condição temporária.",
	...
	serviços:"Bebidas e pratos comuns sem custo, 
...
",
	...
	serviços:" Seus PV máximos aumentam em +5 por patamar. Inclui vários quartos especiais para sereias, elfos-do-mar, devotos de Allihanna…",
	...
	serviços:"A guilda oferece missões requisitadas por outros NPCs. A natureza de cada missão e sua recompensa podem ser escolhidas pelo mestre, ou 
resolvidas aleatoriamente usando a tabela na página 34.",
	...
	serviços:"Itens alquímicos. Também  vende poções mágicas. Para comprar uma poção de uma 1d6. Se o resultado é maior que o círculo da poção desejada, ela está disponível.",
...
descricao: "Antes mesmo de chegar à praça principal, pode-se ouvir o burburinho. Bazares se espalham de forma aparentemente caótica, mas o olhar atento logo percebe certa organização. Mercadores anunciam suas ofertas, clientes negociam pechinchas. Vocês logo percebem estar no coração comercial de Candeh’ssa: o Mercado. Aqui se encontra todo tipo de mercadoria — assim como todo tipo de gente. Uma enorme banca se sobressai, oferecendo quinquilharias estranhamente ordenadas, apesar da grande quantidade. Esta tenda pertence a Tharuk, o mercador, e sua filha Nahiri. Também chama atenção uma banca menor, porém cheirosa e vistosa: pertence a Lyssara, a florista."
	serviços:"Todos os itens comuns (não mágicos) presentes no livro básico Tormenta20, não encontrados nos outros locais de Candeh’ssa (bem como quaisquer outras coisas a critério do mestre).",
	...
	serviços:" O Pesqueiro oferece descanso e… peixes. Um personagem que escolha ficar aqui faz um teste de Sobrevivência (CD 15). Se passar, consegue 
um pescado (peixe, crustáceo, molusco etc.). Para cada 10 que excede a CD, um pescado adicional. Pescados podem ser oferecidos a Andris para serem tratados, rendendo 1 recurso natural (Ameaças de Arton, p. 401) do tipo mantimento ou osso por pescado. Um personagem também pode vender cada pescado por 
2d10 x 10 T$ cada.", 
	...
	serviços:" Quaisquer itens da categoria Alimentação. Sempre cheia, a taverna é também lugar propício para testes de Jogatina nas mesas de jogo e Investigação sobre as masmorras ou a própria cidade. Personagens treinados em Atuação podem se apresentar no palco para obter alguns tibares.
",
	...
	serviços:" Ritos de penitência para devotos que tenham violado Obrigações & Restrições de suas divindades. Também oferece água benta, itens esotéricos que afetam magias divinas e serviços de magias divinas. Devotos de deuses que canalizam energia positiva recebem 10% de desconto em qualquer transação.",
